...
import { updatePassword, getRiderProfile } from "../../redux/actions/riderActions"; // Import rider actions
...
const ChangePassword = ({ navigation }) => {
    ...
    // Select rider data from Redux state
    ...
    const submitHandler = async () => {
        ...
        try {
            const response = await dispatch(updatePassword(rider._id, passwordData)); // Pass the correct data structure
            Toast.show({
                type: 'success',
    ...
    useEffect(() => {
        const loadRiderData = async () => {
            await dispatch(getRiderProfile()); // Load rider data when the component mounts
        };
